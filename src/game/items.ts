...
export function drawItemIcon(def: ItemDef): { url: string; canvas: HTMLCanvasElement } {
  ...
  if (a.kind === 'tool') {
    ...
    if (a.tool === 'pickaxe') {
      ...
      poly([[18,2],[25,2],[29,5],[29,13],[25,17],[20,17],[16,12],[13,9],[16,5]],outline);
      poly([[18,4],[24,3],[27,6],[27,12],[24,15],[21,15],[17,11],[16,8]],H);
      poly([[24,4],[27,6],[27,12],[24,15],[21,15],[23,12],[25,10]],D);
      poly([[18,4],[22,3],[24,3],[22,5],[19,6],[18,9],[16,8]],shine);
      rect(18,10,3,3,'#b38c4b'); rect(19,10,1,1,'#f0cd85');
